...
const pLearn = 'kmuni-tech-frontend/src/data/selfLearn.ts';
...
code = code.replace(
  ...
  `  {
    ...
    enabled: true,
    topics: [
      { key: 'python', title: 'Python Basics', description: 'Core Python for Data & AI.', levels: ['Beginner', 'Intermediate'] },
      { key: 'ml', title: 'Machine Learning', description: 'Concepts of model training.', levels: ['Beginner'] }
    ],
  },`
);
...
code = code.replace(
  ...
  `  {
    ...
    enabled: true,
    topics: [
      { key: 'sql', title: 'SQL', description: 'Query and manage relational data.', levels: ['Beginner', 'Intermediate'] }
    ],
  },`
);
...
code = code.replace(
  ...
  `  {
    ...
    enabled: true,
    topics: [
      { key: 'git', title: 'Git & GitHub', description: 'Version control for teams.', levels: ['Beginner'] }
    ],
  },`
);
...
// Now patch selfLearnActivities.ts
const pAct = 'kmuni-tech-frontend/src/data/selfLearnActivities.ts';
