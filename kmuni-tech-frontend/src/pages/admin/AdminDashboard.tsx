  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard icon={<Users size={18} />} label="Total Users" value={analytics?.totalUsers ?? '—'} color="from-blue-500 to-green-500" />
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link to="/admin/users" className="text-blue-400 hover:text-blue-300 text-sm flex items-center gap-1">View all <ArrowRight size={13} /></Link>
          </div>
