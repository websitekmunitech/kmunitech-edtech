    ...
    <div className="min-h-screen bg-[#0a0b14]">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 rounded-3xl p-12">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-indigo-500/30 rounded-2xl mb-6">
                <GraduationCap className="text-indigo-400" size={40} />
              </div>
              <h2 className="text-4xl font-bold text-white mb-6">
                Universe <span className="text-indigo-400">Platform</span>
              </h2>
              ...
              <Link 
                to="/courses" 
                className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-xl font-medium transition-colors"
              >
                Explore Universe
                <ArrowRight size={18} />
              </Link>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 relative overflow-hidden">
              <div className="absolute top-4 right-4 bg-indigo-500/20 text-indigo-400 text-xs font-semibold px-3 py-1 rounded-full">
                Q3 2026
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 relative overflow-hidden">
              <div className="absolute top-4 right-4 bg-purple-500/20 text-purple-400 text-xs font-semibold px-3 py-1 rounded-full">
                Q4 2026
              </div>
