    ...
    <div className="min-h-screen bg-[#0a0b14]">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Vision Section */}
          <div className="mb-16">
            <div className="bg-gradient-to-br from-blue-500/10 to-green-500/10 border border-blue-500/20 rounded-2xl p-8 md:p-12">
          ...
          {/* Mission Section */}
          <div className="mb-16">
            <div className="bg-gradient-to-br from-green-500/10 to-pink-500/10 border border-green-500/20 rounded-2xl p-8 md:p-12">
              <div className="flex items-center gap-3 mb-6">
              ...
              <p className="text-lg text-slate-300 leading-relaxed mb-6">
                UniVerse is dedicated to revolutionizing the educational landscape by delivering cutting-edge technology 
